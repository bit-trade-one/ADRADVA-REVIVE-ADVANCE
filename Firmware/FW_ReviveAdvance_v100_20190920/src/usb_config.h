...
#define HID_EP1 		1       // Keyboard
#define HID_EP2 		2       // Mouse
#define HID_EP3 		3       // Joystick
#define HID_EP4 		4       // USB Comm
#define HID_INT_OUT_EP_SIZE     1
#define HID_INT_IN_EP_SIZE      8
#define HID_NUM_OF_DSC          1
#define HID_RPT01_SIZE          63      // Keyboard
#define HID_RPT02_SIZE          67      // Mouse チルト機能対応
//#define HID_RPT02_SIZE          52      // Mouse
#define HID_RPT03_SIZE          82      // Joystick
//#define HID_RPT03_SIZE          47      // Multimedia
//#define HID_RPT03_SIZE          69      // Multimedia
#define HID_RPT04_SIZE          29      // USB Comm
